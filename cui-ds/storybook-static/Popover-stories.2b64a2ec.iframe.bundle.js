...
`,Popover=({title,content,children})=>{const[visible,setVisible]=(0,react.useState)(!1);return(0,jsx_runtime.jsxs)(Wrapper,{children:[(0,jsx_runtime.jsx)("div",{onClick:()=>setVisible(!visible),children}),(0,jsx_runtime.jsxs)(Panel,{$visible:visible,children:[title&&(0,jsx_runtime.jsx)(Title,{children:title}),(0,jsx_runtime.jsx)(Content,{children:content})]})]})};Popover.__docgenInfo={description:"",methods:[],displayName:"Popover",props:{title:{required:!1,tsType:{name:"string"},description:""},content:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};var Button=__webpack_require__("./src/components/Button/index.ts");const Popover_stories={title:"Components/Popover",component:Popover},Default={args:{title:"Account Info",content:"Your checking account balance is $12,450.00.",children:(0,jsx_runtime.jsx)(Button.$,{variant:"Secondary",children:"Show Info"})}},NoTitle={args:{content:"Click outside to dismiss this popover.",children:(0,jsx_runtime.jsx)(Button.$,{variant:"Outline",children:"Click me"})}},__namedExportsOrder=["Default","NoTitle"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {\n    title: 'Account Info',\n    content: 'Your checking account balance is $12,450.00.',\n    children: <Button variant=\"Secondary\">Show Info</Button>\n  }\n}",...Default.parameters?.docs?.source}}},NoTitle.parameters={...NoTitle.parameters,docs:{...NoTitle.parameters?.docs,source:{originalSource:"{\n  args: {\n    content: 'Click outside to dismiss this popover.',\n    children: <Button variant=\"Outline\">Click me</Button>\n  }\n}",...NoTitle.parameters?.docs?.source}}}},"./src/components/Button/index.ts"(__unused_webpack_module,__webpack_exports__,__webpack_require__){__webpack_require__.d(__webpack_exports__,{$:()=>Button});var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js"),styled_components_browser_esm=(__webpack_require__("./node_modules/react/index.js"),__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"));const StyledButton=styled_components_browser_esm.Ay.button`
  display: inline-flex;
  align-items: center;
...
//# sourceMappingURL=Popover-stories.2b64a2ec.iframe.bundle.js.map